...
<section class="testimonials">
  <div class="container">
    <div class="abt_heading_wrapper" style="background-color: transparent;">
      <h2 class="f700 blue text-center pb-0" style="color: #00626f;">What Patients are Saying</h2>
    </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-12">
         <div class="item">
            <div class="slide-item">
               <img src="{{ asset('/resources/assets/images/google-icon.png')}}" class="google-icon">
               <h5>Surya Naik-Salunkhe</h5> 
               <img src="{{ asset('/resources/assets/images/star.png')}}" class="mb-4 star-icon">
               <p class="pb-2">The services that we received from Dr. Bharat Kumar is excellent. Doctor sir alongwith the staff of MITR hospital are friendly and ensure that we are properly informed about our patients health and care. He treated my mom, Mrs. Priyanka Naik for knee replacement surgery and the entire process went very smoothly. This is just because of hospital staff and Dr. Bharatkumar sir's personal envolvement in patients speedy recovery.</p>
            </div>
         </div>
      </div>
      <div class="col-md-12">
         <div class="item">
            <div class="slide-item">
               ...
               <h5>Rakesh Gavate</h5> 
               <img src="{{ asset('/resources/assets/images/star.png')}}" class="mb-4 star-icon">
               <p class="pb-2">Dr Bharat Kumar is very good Orthopedic doctor who has replaced both the pairs of knees of my father. Abhi vah bahut acche tarike se chal sakte hain. His charges are also very reasonable. Thank you doctor.</p>
            </div>
         </div>
      </div>
      <div class="col-md-12">
         <div class="item">
            <div class="slide-item">
               <img src="{{ asset('/resources/assets/images/google-icon.png')}}" class="google-icon">
               <h5>Tatyasaheb Kharat</h5> 
               <img src="{{ asset('/resources/assets/images/star.png')}}" class="mb-4 star-icon">
               <p class="pb-2">Doctor Bharat is a very good hand doctor. He did surgery on my hand. His experience is very good and he communicates very well with the patients. Surgery is very affordable. Thank you doctor.</p>
            </div>
         </div>
      </div>
      <div class="col-md-12">
         <div class="item">
            <div class="slide-item">
               ...
               <h5>Amol Pukale</h5> 
               <img src="{{ asset('/resources/assets/images/star.png')}}" class="mb-4 star-icon">
               <p class="pb-2">Doctor Bharat Kumar (Bone Doctor) did my left leg surgery. He is a very good doctor. He gave me so much information about the surgery that my fear went away. He is the best doctor in Navi Mumbai.</p>
            </div>
         </div>
      </div>
      <div class="col-md-12">
