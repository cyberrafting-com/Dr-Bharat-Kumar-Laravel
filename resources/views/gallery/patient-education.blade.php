...
<section class="testimonials">
  <div class="container">
    <div class="abt_heading_wrapper" style="background-color: transparent;padding: 40px 0;">
      <h2 class="f700 blue text-center pb-0" style="color: #00626f;">Patient Education Videos</h2>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <iframe width="100%" height="290" src="https://www.youtube.com/embed/fJFI7_VJ5go" title="Dr Bharat Kumar - How long does it take to Recover from Hip Replacement Surgery Home Part 2" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>

        <div class="col-md-4">
            <iframe width="100%" height="290" src="https://www.youtube.com/embed/LvSiY2iGmPM" title="Dr  Bharatkumar Gangaraju Difference between Partial &amp; Total knee replacement" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>

        <div class="col-md-4">
            <iframe width="100%" height="290" src="https://www.youtube.com/embed/YJ2EAFkHLf4" title="Dr  Bharatkumar Gangaraju Knee replacement Myths and facts" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>

        <div class="col-md-4">
            <iframe width="100%" height="290" src="https://www.youtube.com/embed/fd_QyeYi0bI" title="Understanding Hip Replacement Surgery: Insights from Dr. Gangaraju Bharatkumar" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
